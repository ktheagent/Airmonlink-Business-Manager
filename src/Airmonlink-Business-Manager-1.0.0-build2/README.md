...
- Canonical source package: `Airmonlink-Business-Manager-Full-Source-1.0.0-build2.zip`
...
5. Download the artifact named `Airmonlink-Business-Manager-1.0.0-build2-Windows`.
...
The next controlled releases should add staff accounts and permissions, receipt printing, returns, purchase orders, detailed payment ledgers, audit history, licensing, automatic cloud backups and multi-branch synchronization.

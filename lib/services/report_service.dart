...
class ReportService {
  ...
  Future<Uint8List> buildSummaryPdf({
    ...
    final safeBusinessName = businessName.trim().isEmpty ? 'My Business' : businessName.trim();
  ...
  Future<Uint8List> buildReceiptPdf({
    ...
    final safeBusinessName = businessName.trim().isEmpty ? 'My Business' : businessName.trim();
    final receiptFormat = _safeReceiptFormat(pageFormat);
    final document = pw.Document(
        ...
        build: (context) => pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
              ...
              pw.Text(businessName.trim().isEmpty ? 'My Business' : businessName.trim()),
  ...
  static PdfPageFormat _safeReceiptFormat(PdfPageFormat requested) {
    if (!requested.width.isFinite || requested.width <= 0) {
      return PdfPageFormat.roll80;
    }
    if (requested.width <= 65 * PdfPageFormat.mm) {
  ...
  static Uint8List _validatedPdfBytes(Uint8List bytes, String documentName) {
    ...
    if (bytes.length < 500 || header != '%PDF-') {
      throw StateError('The $documentName PDF could not be generated correctly.');
    }
    return bytes;
  }
